% [MLaG , MGaL]=calcular_matrices_g_a_l(i,j,k)
...
%   segmento en estudio para un frame determinado.
% EJEMPLO
%   matrices de cambio de base local a golbal y viceversa del muslo
%   derecho:
%   [MLaG.musloDerecho , MGaL.musloDerecho]=calcular_matrices_g_a_l(iMusloDerecho,jMusloDerecho,kMusloDerecho)
% 
