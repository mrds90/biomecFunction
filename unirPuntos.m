...
% ENTRADA
%   color: es una variable del tipo char de tamaño [1×1] y es el mismo
...
%   graficar. es una variable del tipo int y tamaño [1×1].
...
%   tamaño [n×3] cuyos elementos son del tipo double. n es tipicamente la
...
% SALIDA
%   la salida de la función es una grafica en el espacio 3d donde se unen
