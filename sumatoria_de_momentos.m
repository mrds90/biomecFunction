...
% aplicacion.
% ENTRADA
%   centroDeMomento: es la ubicación en el espacio del centro de masa del
%   segmento en estudio. Sus elementos son del tipo double y su tamaño es
...
%   del sitema coordenado global. El tamaño de esta variable debe ser igual
...
%   el caso del pie). El tamaño debe ser igual al del argumento
...
%   función con una cantidad variable de argumentos. Para esta función la
...
%   una fuerza y el segundo al punto de aplicación de esa fuerza. Tanto la
%   variable que representa la fuerza (en Newtons) y la que representa el
%   punto de aplicación (en metros) tendrán elementos del tipo double y el
%   mismo tamaño que la variable "centroDeMasaDelPie".
% SALIDA
%   momentoResultante: es una matriz del mismo tamaño que la variable
...
%   términos del sistema coordenado global. Sus valores estan en N×m y sus 
