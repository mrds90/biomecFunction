...
% ENTRADA
%   masa: peso del segmento en estudio en Kilogramos. Es del tipo numérico
%   y tamaño [1×1]
%   aceleracion: es la aceleración lineal (representación vectorial) del 
%   centro de masa del segmento en estudio. Su tamaño es de [n×3] donde n
%   toma valores mayor o igual a 1 (es tipicamente la cantidad de frames en
%   estudio). Cada fila de esta variable es el vector aceleración para un
%   frame. La unidad de esta variable es m/s^2
%   varagin: es la o las fuerzas que se aplican sobre el segmento en
%   estudio. El formato es del tipo numérico y debe tener el mismo fotmato
...
%   llamada de la función. Cada fila de esta variable es un vector fuerza
%   aplicado al segmento en estudio para un frame. La unidad de esta 
%   variable es Newton
% SALIDA
%   fuerzaResultante: es una matriz del mismo tamaño que la variable
%   "aceleración" donde cada fila, de esta, representa la fuerza necesaria 
