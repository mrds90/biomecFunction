...
% Util para expresar la fuerza global en termino de los ejes anatómicos.
% ENTRADA
    ...
    % versor cuya orientación se corresponde a la medial/lateral o 
    % lateral/medial (segun lado) de la articulación que se esta evaluando.
...
%   proyección de la fuerza de entrada (variable "vector") en los ejes 
